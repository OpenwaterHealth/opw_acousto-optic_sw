...
#if defined(__linux__) || defined(__FreeBSD__) || defined(__clang__)   /* Linux, FreeBSD, Clang */
...
int RS232_OpenComport(int comport_number, int baudrate, const char *mode)
{
  ...
  switch(baudrate)
  {
    ...
    case  230400 : baudr = B230400;
                   break;
#ifdef B460800  // Not avbailable on Mac.  -jfs
...
int RS232_OpenComport(int comport_number, int baudrate, const char *mode)
{
  ...
  */
  sprintf_s(mode_str, 128, "baud=%d", baudrate);
